...
Declaration addMethod(Declaration targetClass, Declaration targetMethod){
...
set[Declaration] moveMethod(set[Declaration] asts, loc methodDecl, loc destinationClassDecl){
	...
	if(isMethodTransferable(sourceClass, destinationClass, targetMethod)){
